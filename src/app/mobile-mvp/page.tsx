  ...
  return (
    <main className="min-h-screen bg-[#f49f68] p-8 md:p-12 font-sans">
      <div className="max-w-[1400px] mx-auto">
        <h1 className="text-3xl md:text-5xl font-bold text-white mb-10 text-center md:text-left leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6 lg:col-span-5 lg:sticky lg:top-12 order-2 lg:order-1">
            ...
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-md">
              <h3 className="font-bold text-xl text-orange-600 mb-2">
                1. Maquetación de pantallas en React Native
              </h3>
              <p className="text-gray-800 leading-relaxed">
                Implementación de pantallas desde Figma usando TypeScript,
                NativeWind y herramientas como ScrollView y useSafeAreaInsets
                para adaptar correctamente la interfaz a distintos dispositivos.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6 lg:gap-8 lg:col-span-7 order-1 lg:order-2">
            {/* Imagen 1: Tamaño 200x400 (Ratio 1:2) */}
            <Image
              src="/img/mobile1.png"
            ...
            {/* Imagen 2: Tamaño 200x400 (Ratio 1:2) + margen superior en desktop */}
            <Image
              src="/img/mobile2.png"
              alt="Pantalla de detalle"
              width={200}
              height={400}
              className="w-full h-auto transition-transform duration-300 transform hover:scale-105 cursor-pointer sm:mt-12"
            />

            {/* Imagen 3: Tamaño 200x400 (Ratio 1:2) */}
            <Image
              src="/img/mobile3.png"
            ...
            {/* Imagen 4: Tamaño 200x400 (Ratio 1:2) + margen superior en desktop */}
            <Image
              src="/img/mobile4.png"
